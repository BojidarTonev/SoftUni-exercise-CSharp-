    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PatientId = table.Column<int>(nullable: false),
                    FK_PatientMedicament_Patient = table.Column<int>(nullable: false),
                    MedicamentId = table.Column<int>(nullable: false),
                    FK_PatientMedicament_Medicaments = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prescriptions", x => new { x.PatientId, x.MedicamentId });
                    table.ForeignKey(
                        name: "FK_Prescriptions_Medicaments_FK_PatientMedicament_Medicaments",
                        column: x => x.FK_PatientMedicament_Medicaments,
                        principalTable: "Medicaments",
                        principalColumn: "MedicamentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Patients_FK_PatientMedicament_Patient",
                        column: x => x.FK_PatientMedicament_Patient,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_FK_PatientMedicament_Medicaments",
                table: "Prescriptions",
                column: "FK_PatientMedicament_Medicaments");

            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_FK_PatientMedicament_Patient",
                table: "Prescriptions",
                column: "FK_PatientMedicament_Patient");
