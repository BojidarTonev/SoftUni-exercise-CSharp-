...
CREATE TABLE Orders(
	...
	CONSTRAINT FK_Orders_Collection_Office FOREIGN KEY (CollectionOfficeId) REFERENCES Offices(Id),
	CONSTRAINT FK_Orders_Return_Office FOREIGN KEY (ReturnOfficeId) REFERENCES Offices(Id)
)